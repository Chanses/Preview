...
export const easeLinear: EasingFunction = (x) => x;
...
export const easeInExpo: EasingFunction = (x) => (x === 0 ? 0 : pow(2, 10 * x - 10));
export const easeOutExpo: EasingFunction = (x) => (x === 1 ? 1 : 1 - pow(2, -10 * x));
...
export const easeOutBack: EasingFunction = (x) => 1 + c3 * pow(x - 1, 3) + c1 * pow(x - 1, 2);
